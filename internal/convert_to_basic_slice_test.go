...
func Test_ToIntSlice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToIntSlice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToIntSlice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
...
func Test_ToInt8Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToInt8Slice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToInt8Slice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToInt16Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToInt16Slice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToInt16Slice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToInt32Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToInt32Slice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToInt32Slice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToInt64Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToInt64Slice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToInt64Slice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToUintSlice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToUintSlice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToUintSlice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToUint8Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToUint8Slice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToUint8Slice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToUint16Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToUint16Slice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToUint16Slice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToUint32Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToUint32Slice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToUint32Slice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToUint64Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToUint64Slice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToUint64Slice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToUintptrSlice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToUintptrSlice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToUintptrSlice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToFloat32Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToFloat32Slice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToFloat32Slice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToFloat64Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToFloat64Slice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToFloat64Slice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToBoolSlice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToBoolSlice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToBoolSlice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToComplex64Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToComplex64Slice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToComplex64Slice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToComplex128Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToComplex128Slice - []interface{}{-str-}", args: []interface{}{"str"}, errContain: "can't convert"},
		{name: "ToComplex128Slice - [2]interface{}{-str-}", args: [2]interface{}{"str"}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_ToStringSlice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ToStringSlice - []interface{}{false}", args: []interface{}{false}, errContain: "can't convert"},
		{name: "ToStringSlice - [2]interface{}{false}", args: [2]interface{}{false}, errContain: "can't convert"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
